            ...
            <div className="tab-content">
              ...
              <div className="tab-pane" id="tab-2">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="./user/assets/img/specials-2.png" alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-3">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="./user/assets/img/specials-3.png" alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-4">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="./user/assets/img/specials-4.png" alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-5">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="./user/assets/img/specials-5.png" alt="" className="img-fluid"/>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="testimonial-item">
                ...
                <img src="./user/assets/img/testimonials/testimonials-4.jpg" className="testimonial-img" alt=""/>
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
              </div>
            </div>
